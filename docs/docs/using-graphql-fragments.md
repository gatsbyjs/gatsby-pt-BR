---
title: Utilizando Fragmentos do GraphQL
---
...
Um fragmento pode ser criado dentro de qualquer consulta GraphQL, mas é uma boa prática criar a consulta separadamente. Mais conselhos organizacionais no [Guia Conceitual](/docs/graphql-concepts/#fragments).
...
- [Consultando Dados com GraphQL - Fragmentos](/docs/graphql-concepts/#fragments)
