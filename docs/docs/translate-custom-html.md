...
Gatsby utiliza um componente React para a renderização do servidor '<head>' e outras partes do HTML fora do aplicativo principal do Gatsby. Além diso, o Gatsby define um valor padrão do ´<noscript>´ marcado aqui.
